-- ============================================================
-- Añadir ruta_polyline al subplan para evitar llamadas repetidas
-- a Directions API — cada segmento terrestre se llama solo 1 vez
-- Ejecutar en Supabase Dashboard → SQL Editor
-- ============================================================

ALTER TABLE subplan
  ADD COLUMN IF NOT EXISTS ruta_polyline text;

-- Recrear fn_subplan_list con el nuevo campo
