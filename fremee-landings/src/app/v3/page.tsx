...
import V3ScrollEffects from "./V3ScrollEffects";
...
function PhoneMockup() {
  return (
    <div className="v3-phone" aria-label="Mockup de la app Frimee">
      <div className="v3-phone-frame">
        <div className="v3-phone-notch" />
        <div className="v3-video">
          <div className="v3-video-top">
            <span>9:41</span>
          </div>
          <div className="v3-video-feed">
            <div className="v3-video-card v3-video-card-main">
              <span>Lisboa</span>
              <strong>12-15 julio</strong>
            </div>
            <div className="v3-video-row">
              <div>
                <span>Votos</span>
                <strong>6/7</strong>
              </div>
            ...
            <div className="v3-video-chat">
              <span>Paula confirmó hotel</span>
              <span>Mario subió vuelos</span>
              <span>Nuevo plan: mirador</span>
            </div>
          </div>
        </div>
      </div>
...
export default function LandingV3Page() {
  return (
    <main className="landing-page v3-page min-h-dvh bg-[#f7f7f4] text-[var(--text-primary)]">
      <V3ScrollEffects />
      <Navbar />
