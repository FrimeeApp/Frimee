  ...
  const created = await runTransaction(db, async (tx) => {
    ...
    tx.set(
      postRef,
      {
        ...
        ...(payload.plan.publicationConfig != null ? { publicationConfig: payload.plan.publicationConfig } : {}),
        itinerarySnapshot: payload.plan.itinerarySnapshot ?? null,
        photosSnapshot: payload.plan.photosSnapshot ?? null,
        expensesSnapshot: payload.plan.expensesSnapshot ?? null,
        participantsSnapshot: payload.plan.participantsSnapshot ?? null,
